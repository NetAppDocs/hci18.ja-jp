...
詳細については、を参照して https://docs.netapp.com/sfe-122/topic/com.netapp.doc.sfe-ug/GUID-057D852C-9C1C-458A-9161-328EDA349B00.html["SolidFire と Element ドキュメントセンター"^]ください。
...
はlink:concept_hci_clusters.html#authoritative-storage-clusters["信頼できるストレージクラスタです"]、NetApp Hybrid Cloud Controlがユーザの認証に使用するストレージクラスタです。
