...
NOTE: vCenter インスタンスは、少なくとも 1 つの NetApp HCI コンピューティングノードがそのインスタンスに関連付けられている場合にのみコンピューティングペインに表示されます。NetApp Hybrid Cloud ControlでリンクされているvCenterインスタンスを一覧表示するには、を使用しlink:task_mnode_edit_vcenter_assets.html["API"]ます。
...
TIP: クラスタの健常性を確認するには、 SolidFire Active IQ のダッシュボードも参照してください。を参照して link:task_hcc_activeiq.html["NetApp SolidFire Active IQ で、パフォーマンス、容量、クラスタの健全性を監視します"]
...
TIP: 関連するクラスタしきい値Element APIの詳細については、_Element APIガイド_のを参照してください https://docs.netapp.com/us-en/element-software/api/reference_element_api_getclusterfullthreshold.html["「 getClusterFullThreshold 」"^]。ブロック容量とメタデータ容量の詳細を表示するには、_Elementユーザガイド_のを参照してください https://docs.netapp.com/us-en/element-software/storage/concept_monitor_understand_cluster_fullness_levels.html["クラスタフルレベルの概要"^]。
...
+
を参照して link:concept_hcc_expandoverview.html["拡張の概要"]



. 詳細な分析と歴史的背景については、を参照してください https://activeiq.solidfire.com/["NetApp SolidFire Active IQ の詳細"^]。
...
関連付けられているElement APIメソッドの詳細については、_Element APIリファレンスガイド_のメソッドを参照してください https://docs.netapp.com/us-en/element-software/api/reference_element_api_getclusterstats.html["GetClusterStats から参照できます"^]。
...
+
https://docs.netapp.com/us-en/vcp/vcp_task_reports_volume_performance.html["NetApp Element Plug-in for vCenter Server に表示されるパフォーマンス"^]です。
...
. 計算情報の詳細な分析については、を参照してください https://activeiq.solidfire.com["履歴データ用の NetApp SolidFire Active IQ"^]。
